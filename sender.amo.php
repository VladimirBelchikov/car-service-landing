...
$tosend = "88007753106@mail.ru"; //To:
$subject = "Продажа автосервисного оборудования с доставкой по России"; //Subject:
$from_name = "Центр Технического Оборудования"; //From:
$from_email = "avtoservis_new@email.com"; //From:
////NO EDIT
if (!isset($_POST['act'])) {
    exit();
}
